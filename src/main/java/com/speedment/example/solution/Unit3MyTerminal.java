...
public final class Unit3MyTerminal implements Unit3Terminal {
    ...
    public Optional<String> findLongestString(Stream<String> stream) {
        //return stream.min(String::compareTo); intellij improvement
        //return stream.max(Comparator.comparingInt(String::length)); chatpgt solution
        return stream.sorted(String::compareTo).findFirst();
    }
